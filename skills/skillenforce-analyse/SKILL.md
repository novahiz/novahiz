...
description: |
  Step 4 of the skillenforce pipeline: understand the affected code before modifying it.
...
The files and symbols that carry the logic, data paths, extension points, and an explicit list of remaining unknowns. This output feeds `skillenforce-implement`.
