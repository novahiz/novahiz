...
description: |
  Step 2 of the skillenforce pipeline: remove ambiguities before locking the plan.
...
# skillenforce-clarify: remove ambiguities
...
A short list: open families, questions asked, answers received, decisions locked. Move to `skillenforce-task` when the remaining open items no longer change architecture, data, tasks, tests, UX, or operations.
