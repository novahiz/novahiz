...
const catalog: CatalogSkill[] = [
  ...
  { id: "anti-AI-design", name: "anti-AI-design", description: "Eliminate generic AI-generated design patterns from UI", power: 5, stars: null, tags: ["design", "ui"], categories: ["design-ui"] },
...
test("ranks the most relevant skill first", () => {
  ...
  assert.equal(ranked[0].id, "anti-AI-design");
});
